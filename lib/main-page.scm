		...
		(set-page-title! "(sioBuD.com)")
			(template
				`(div (@ (id "welcome"))
						...
						(br)
						(h1 (@ (style "font-size: 30px")) "My day job involves "(span (@ (style "font-weight: 700")) "programming") ", but I like other stuff also. Take a look around! Make sure to check out my  "(a (@ (class "fancyAnchor") (href "/blog") (style "font-weight: 700")) "Blog"))
						(h1 (@ (style "font-size: 30px; padding-top: 5em")) "Important Note!")
